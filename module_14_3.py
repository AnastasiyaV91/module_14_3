...
async def get_buying_list(message):
    with open("files/1.jpg", "rb") as img1:
        ...
        f"Название: Product {texts.Product1} | Описание: описание {texts.Product1} | Цена: {texts.Product1 * 100}")
    with open("files/2.jpg", "rb") as img2:
        await message.answer_photo(img2,
        f"Название: Product {texts.Product2} | Описание: описание {texts.Product2} | Цена: {texts.Product2 * 100}")
    with open("files/3.jpg", "rb") as img3:
        await message.answer_photo(img3,
        f"Название: Product {texts.Product3} | Описание: описание {texts.Product3} | Цена: {texts.Product3 * 100}")
    with open("files/4.jpg", "rb") as img4:
        await message.answer_photo(img4,
        f"Название: Product {texts.Product4} | Описание: описание {texts.Product4} | Цена: {texts.Product4 * 100}")
